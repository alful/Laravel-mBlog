...
<link href="assets/01-homepage/css/style.css" style="stylesheet">
<link href="assets/01-homepage/css/responsive.css" style="stylesheet">
@endsection
...
<div class="main-slider">
    <div id="slider">
        ...
        <div class="ls-slide" data-ls="bgsize:cover; bgpostition:50% 50%; duration:4000; transition2d:104; kenburnsscale:1.00;">
            <img src="{{url($slider->image)}}" class="ls-bg" alt=""/>
            <div class="slider-content ls-1" style="top:60%; left:30%;" data-ls="offsetyin:100%; offsetxout:-50%; duration:800; delayin:100; durationout:400;parallaxlevel:0;">
...
<div class="single-post">
    ...
    <div class="icons">
        <div class="left-area">
            <a class="btn category-btn" href="{{url('category/'.$headline->category->id)}}"><b> {{$headline->category->name}}</b></a>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-12">
        <div class="single-post">
            ...
            <div class="icons">
                <div class="left-area">
                    <a class="btn category-btn" href="{{url('category/'.$posts->category->id)}}"><b>{{$posts->category->name}}</b></a>
                </div>
            </div>
