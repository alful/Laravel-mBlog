...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggleeDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
	...
	<footer class="footer navbar fixed-bottom bg-dark">
		<div class="container">
			<span class="text-muted">&copy; 2021 BK UDINUS</span>
		</div>
	</footer>
