...
@section('content')
    ...
    <div class="col-lg-6">
        ...
        @endif
        <form action="{{url('admin/posts/edit/'.$data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <a href="{{url('admin/posts')}}" class="btn btn-md btn-warning"><i class="fas fa-chevron-circle-left"></i>Kembali</a>
        </form>
    </div>
@endsection
